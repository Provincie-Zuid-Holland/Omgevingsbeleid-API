...
from app.extensions.publications.models.api_input_data import ApiAnnouncementInputData, DocFrbr
...
from app.extensions.publications.services.announcement_package.announcement_state_patcher import (
...
class AnnouncementPackageBuilder:
    ...
    def create_new_state(self) -> Optional[PublicationEnvironmentStateTable]:
        ...
        state_changer: AnnouncementStatePatcher = AnnouncementStatePatcher(self._api_input_data, self._dso_builder)
