...
class Thema(Base):
    ...
    Created_By = relationship("Gebruiker", primaryjoin="Thema.Created_By_UUID == Gebruiker.UUID")
    Modified_By = relationship("Gebruiker", primaryjoin="Thema.Modified_By_UUID == Gebruiker.UUID")
