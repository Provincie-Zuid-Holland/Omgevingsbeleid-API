...
from app.extensions.publications.services.state.versions.v3.actions import (
    Action,
...
class StateV3(State):
    ...
    def handle_action(self, action: Action):
        match action:
            ...
            case _:
                raise RuntimeError(f"Action {action.__class__.__name__} is not implemented for StateV3")
