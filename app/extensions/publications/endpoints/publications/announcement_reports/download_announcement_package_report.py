...
class DownloadAnnouncementPackageReportEndpoint(Endpoint):
...
class DownloadAnnouncementPackageReportEndpointResolver(EndpointResolver):
    def get_id(self) -> str:
        return "download_publication_announcement_package_report"
    ...
    def generate_endpoint(
        ...
        return DownloadAnnouncementPackageReportEndpoint(path=path)
