import uuid
from typing import Annotated, List, Optional, Dict, Generic, Sequence, Tuple
...
from app.api.domains.modules.types import TModel, ObjectStaticShort
...
def do_list_all_latest_endpoint(
    ...
    request_data: ObjectListAllLastestRequestData,
    owner_uuid: Optional[uuid.UUID] = None,
) -> PagedResponse[ObjectListAllLatestResponse]:
    ...
    paginated_result: PaginatedQueryResult = object_repository.get_latest_filtered(
        ...
        object_types=request_data.Object_Types,
    )
