...
class TestGraphService:
    ...
    def test_graph_normal(self, client: TestClient, admin_headers):
        ...
        belang_resp = client.post("v0.1/belangen", headers=admin_headers, json=test_belang)
        ...
        response = client.post("v0.1/beleidskeuzes", headers=admin_headers, json=test_bk)
    ...
    def test_leden_excluded_from_graph(self, client: TestClient, admin_headers, fixture_data):
