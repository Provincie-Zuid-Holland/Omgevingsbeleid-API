...
from app.api.domains.modules.endpoints.list_module_detail_objects_endpoint import (
    ListModuleDetailObjectsEndpointContext,
    ModuleDetailObjectsResponse,
    get_list_module_detail_objects_endpoint,
)
...
class ListModuleDetailObjectsEndpointBuilder(EndpointBuilder):
    ...
    def get_id(self) -> str:
        return "list_module_detail_objects"
    ...
    def build_endpoint(
        ...
        context = ListModuleDetailObjectsEndpointContext(
            order_config=order_config,
            builder_data=builder_data,
            model_map=model_map,
        )
        endpoint = self._inject_context(get_list_module_detail_objects_endpoint, context)

        union_object_type: Union[BaseModel] = self._model_dynamic_type_builder.build_object_union_type(model_map)
        response_type = PagedResponse[ModuleDetailObjectsResponse[union_object_type]]
        ...
        return ConfiguredFastapiEndpoint(
            ...
            summary="List objects in a module with pagination, filtering and sorting",
            description=None,
            tags=["Modules"],
        )
