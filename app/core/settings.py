...
class Settings(BaseSettings):
    ...
    def assemble_db_connection(cls, v: Optional[str], values: Dict[str, Any]) -> Any:
        ...
        db_connection_settings = f"DRIVER={values['DB_DRIVER']};SERVER={values['DB_HOST']};DATABASE={values['DB_NAME']};UID={values['DB_USER']};PWD={values['DB_PASS']};MultipleActiveResultSets=true"
