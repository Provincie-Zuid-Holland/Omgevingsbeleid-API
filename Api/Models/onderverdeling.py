...
class Onderverdeling(CommonMixin, db.Model):
    ...
    Created_By_Gebruiker = relationship(
        "Gebruikers", primaryjoin="Onderverdeling.Created_By == Gebruikers.UUID"
    )
    Modified_By_Gebruiker = relationship(
        "Gebruikers", primaryjoin="Onderverdeling.Modified_By == Gebruikers.UUID"
    )

    Ref_Werkingsgebied = relationship(
        "Werkingsgebieden",
        primaryjoin="Onderverdeling.UUID_Werkingsgebied == Werkingsgebieden.UUID",
    )
