...
def upgrade() -> None:
    ...
    op.drop_column("module_objects", "Description_Choice")
    op.drop_column("module_objects", "Description_Operation")
    op.drop_column("module_objects", "Accomplish")
    op.drop_column("module_objects", "Tags")
    op.drop_column("module_objects", "Consideration")
    op.drop_column("module_objects", "Explanation_Raw")
    op.drop_column("objects", "Description_Choice")
    op.drop_column("objects", "Description_Operation")
    op.drop_column("objects", "Accomplish")
    op.drop_column("objects", "Tags")
    op.drop_column("objects", "Consideration")
    op.drop_column("objects", "Explanation_Raw")
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "objects", sa.Column("Explanation_Raw", sa.NVARCHAR(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "objects", sa.Column("Consideration", sa.NVARCHAR(), autoincrement=False, nullable=True)
    )
    op.add_column("objects", sa.Column("Tags", sa.NVARCHAR(), autoincrement=False, nullable=True))
    op.add_column(
        "objects", sa.Column("Accomplish", sa.NVARCHAR(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "objects",
        sa.Column("Description_Operation", sa.NVARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "objects",
        sa.Column("Description_Choice", sa.NVARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "module_objects",
        sa.Column("Explanation_Raw", sa.NVARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "module_objects",
        sa.Column("Consideration", sa.NVARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "module_objects", sa.Column("Tags", sa.NVARCHAR(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "module_objects", sa.Column("Accomplish", sa.NVARCHAR(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "module_objects",
        sa.Column("Description_Operation", sa.NVARCHAR(), autoincrement=False, nullable=True),
