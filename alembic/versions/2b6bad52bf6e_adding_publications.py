...
Revision ID: 2b6bad52bf6e
Revises: 00c1d7bd6337
Create Date: 2024-02-08 13:42:28.027674
...
def upgrade() -> None:
    ...
    op.create_table('publication_ow_objects',
        ...
        sa.Column('Created_Date', sa.DateTime(), nullable=False),
        sa.Column('Modified_Date', sa.DateTime(), nullable=False),
        sa.Column('OW_ID', sa.Unicode(length=255), nullable=False),
        ...
        sa.Column('Divisie_ref', sa.Unicode(length=255), nullable=True),
        ...
        sa.ForeignKeyConstraint(['Divisie_ref'], ['publication_ow_objects.OW_ID'], ),
    ...
    op.create_table('publication_ow_association',
        sa.Column('OW_ID_1', sa.Unicode(length=255), nullable=False),
        sa.Column('OW_ID_2', sa.Unicode(length=255), nullable=False),
        sa.Column('Type', sa.Unicode(), nullable=True),
        sa.ForeignKeyConstraint(['OW_ID_1'], ['publication_ow_objects.OW_ID'], ),
        sa.ForeignKeyConstraint(['OW_ID_2'], ['publication_ow_objects.OW_ID'], ),
