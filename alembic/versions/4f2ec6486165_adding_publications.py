...
Revision ID: 4f2ec6486165
Revises: 00c1d7bd6337
Create Date: 2024-02-20 10:01:47.075794
...
def upgrade() -> None:
    ...
    op.create_table('publication_package_ow_association',
        sa.Column('Package_UUID', sa.Uuid(), nullable=False),
        sa.Column('OW_ID_HASH', sa.String(length=64), nullable=False),
        sa.ForeignKeyConstraint(['OW_ID_HASH'], ['publication_ow_objects.OW_ID_HASH'], ),
        sa.ForeignKeyConstraint(['Package_UUID'], ['publication_packages.UUID'], ),
