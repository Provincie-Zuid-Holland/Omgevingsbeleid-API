...
def upgrade() -> None:
    ...
    sa.Column('Gebruikersnaam', sa.Unicode(), nullable=True),
    sa.Column('Email', sa.Unicode(length=256), nullable=False),
    sa.Column('Rol', sa.Unicode(), nullable=True),
    ...
    sa.Column('Hash', sa.Unicode(length=64), nullable=False),
    sa.Column('Meta', sa.Unicode(), nullable=False),
    ...
    sa.Column('Object_Type', sa.Unicode(length=25), nullable=False),
    sa.Column('Object_ID', sa.Integer(), nullable=False),
    sa.Column('Code', sa.Unicode(length=35), nullable=False),
    ...
    sa.Column('Cached_Title', sa.Unicode(length=255), nullable=True),
    ...
    sa.Column('Requested_By_Code', sa.Unicode(length=35), nullable=False),
    sa.Column('From_Code', sa.Unicode(length=35), nullable=False),
    sa.Column('From_Acknowledged', sa.DateTime(), nullable=True),
    sa.Column('From_Acknowledged_By_UUID', sa.Uuid(), nullable=True),
    sa.Column('From_Explanation', sa.Unicode(), nullable=False),
    sa.Column('To_Code', sa.Unicode(length=35), nullable=False),
    sa.Column('To_Acknowledged', sa.DateTime(), nullable=True),
    sa.Column('To_Acknowledged_By_UUID', sa.Uuid(), nullable=True),
    sa.Column('To_Explanation', sa.Unicode(), nullable=False),
    ...
    sa.Column('Explanation', sa.Unicode(), nullable=False),
    sa.Column('Conclusion', sa.Unicode(), nullable=False),
    sa.Column('Created_Date', sa.DateTime(), nullable=True),
    sa.Column('Modified_Date', sa.DateTime(), nullable=True),
    sa.Column('Created_By_UUID', sa.Uuid(), nullable=False),
    sa.Column('Modified_By_UUID', sa.Uuid(), nullable=False),
    ...
    sa.Column('Description_Choice', sa.Unicode(), nullable=True),
    sa.Column('Description_Operation', sa.Unicode(), nullable=True),
    sa.Column('Accomplish', sa.Unicode(), nullable=True),
    sa.Column('Effect', sa.Unicode(), nullable=True),
    sa.Column('Role', sa.Unicode(), nullable=True),
    sa.Column('Provincial_Interest', sa.Unicode(), nullable=True),
    sa.Column('Cause', sa.Unicode(), nullable=True),
    sa.Column('Consideration', sa.Unicode(), nullable=True),
    sa.Column('Decision_Number', sa.Unicode(), nullable=True),
    sa.Column('Explanation', sa.Unicode(), nullable=True),
    sa.Column('Explanation_Raw', sa.Unicode(), nullable=True),
    sa.Column('Weblink', sa.Unicode(), nullable=True),
    sa.Column('Tags', sa.Unicode(), nullable=True),
    sa.Column('IDMS_Link', sa.Unicode(), nullable=True),
