...
Revision ID: 07fb2e0a7f03
Revises: 
Create Date: 2023-03-07 16:11:56.536713
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("From_Acknowledged", sa.Boolean(), nullable=False),
        sa.Column("From_Acknowledged_Date", sa.DateTime(), nullable=True),
        ...
        sa.Column("To_Acknowledged_Date", sa.DateTime(), nullable=True),
