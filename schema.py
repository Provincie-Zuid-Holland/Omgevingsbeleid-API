...
class AmbitieQueries(graphene.ObjectType):
    ...
    resolve_ambite = single_object_by_uuid('Ambitie', ambitie_op_uuid)
...
class CreateAmbitie(graphene.Mutation):
    ...
    def mutate(self, info, ambitie_data=None):
        ...
        return CreateAmbitie(ok=True, Ambitie_Uuid=results.first().UUID)
